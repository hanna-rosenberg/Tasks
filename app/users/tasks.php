...
if (isset($_POST['title'], $_POST['task'], $_POST['deadline'])) {
    ...
    $statement = $database->prepare("INSERT INTO tasks (title, description, deadline, user_id) VALUES (:placeholderTitle, :placeholderTask, :placeholderDeadline, :placeholderID)");
